        ...
        <div className="bento-grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="hidden lg:block card p-10 h-full">
            <div className="max-w-sm mx-auto text-center">
              ...
              <h1 className="text-3xl font-bold text-primary-950 dark:text-gray-100 mb-3">Student Performance</h1>
              <p className="text-primary-500 dark:text-gray-400 text-lg mb-8">Track study habits. Predict grades. Improve outcomes.</p>
              ...
              <div className="space-y-4 text-left">
                <div className="flex items-center gap-4 p-4 bg-primary-50/60 dark:bg-primary-950/20 rounded-2xl">
                  ...
                  <div>
                    <p className="font-semibold text-primary-950 dark:text-gray-100">Real-time Analytics</p>
                    <p className="text-sm text-primary-500 dark:text-gray-400">Dashboard with KPIs, charts & trends</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 bg-primary-50/60 dark:bg-primary-950/20 rounded-2xl">
                  ...
                  <div>
                    <p className="font-semibold text-primary-950 dark:text-gray-100">AI-Powered Predictions</p>
                    <p className="text-sm text-primary-500 dark:text-gray-400">ML models predict grades & give advice</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 bg-primary-50/60 dark:bg-primary-950/20 rounded-2xl">
                  ...
                  <div>
                    <p className="font-semibold text-primary-950 dark:text-gray-100">Secure & Private</p>
                    <p className="text-sm text-primary-500 dark:text-gray-400">Your data stays on your server</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="card-clay-hover p-8 w-full">
            ...
            <div className="lg:block text-center mb-8">
              <p className="text-primary-500 dark:text-gray-400">Welcome back. Enter your credentials to access your account.</p>
            </div>
